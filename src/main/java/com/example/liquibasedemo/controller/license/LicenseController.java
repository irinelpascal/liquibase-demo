...
public class LicenseController {
    ...
    public ResponseMessage createLicense(@RequestBody LicenseCreateDTO licenseCreateDTO) {

        Optional<PersonEntity> personById = personRepository.findById(licenseCreateDTO.getPersonEntityId());
